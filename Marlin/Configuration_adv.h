...
#define PWM_MOTOR_CURRENT { 1200, 1000, 900 }          // Values in milliamps
...
#define ENCODER_10X_STEPS_PER_SEC 70    // If the encoder steps per sec exceeds this value, multiply steps moved x10 to quickly advance the value
