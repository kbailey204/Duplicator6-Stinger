...
#define STRING_CONFIG_H_AUTHOR "(Ken Bailey, tweaked config)" // Who made the changes.
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0395, 80.0395, 400.48, 96.50 } // Stock Extruder
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0395, 80.0395, 400.48, 415.00 } // Bondtech Extruder
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 950, 950, 100, 500 }
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP 0.020    // Step size while manually probing Z axis.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 90, 5, 20 }
